      ...
      <div className="relative max-w-screen-md">
        {experiencesData.map(
          ({ title, description, company, period, technologies }) => (
            ...
            >
              <div className="bg-primary/20 absolute left-0 top-2.5 h-full w-[2px] group-first:top-6 group-first:h-[calc(100%-24px)]">
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="border-primary/30 flex size-9 shrink-0 items-center justify-center rounded-full border">
                    <Icons.building className="text-primary/70 size-5" />
                  </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {technologies.map((tech) => (
                    <div
                      key={tech}
                      className="hover:border-primary/60 hover:text-primary rounded-full border px-3 py-1 text-sm transition-colors"
                    >
                      {tech}
                    </div>
                  ))}
